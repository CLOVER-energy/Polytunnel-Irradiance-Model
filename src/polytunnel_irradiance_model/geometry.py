...
class Polytunnel:
    ...
    def __init__(self, radius1 = 1, length = 10, xy_angle = 0, z_angle = 0, x_shift = 0.0, y_shift = 0.0, z_shift = 0.0, theta_margin = 0, cell_thickness = 0, cell_gap = 0, radius2 = None, res_meshgrid = 1.0, initial_cell_gap = 0.0 ):
    ...
    def generate_ground_grid(self):
        ...
        x_ground = np.linspace(-self.radius1+0.0001, self.radius1-0.0001, self.n_angular)
    ...
    def generate_surface(self):
        ...
        if cell_thickness == 0:
            ...
            stripe_width_grids = int( self.cell_thickness / ( self.res_meshgrid ))  # 35 cm -> grids
            stripe_spacing_grids = int( self.cell_gap / ( self.res_meshgrid ))  # 100 cm -> grids
            initial_spacing_grids = int( self.initial_cell_gap / ( self.res_meshgrid ))  # 50 cm -> grids
